...
class App(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.tab1_instance = Tab1(self.organizer)
       ...
       # self.tab2_instance = Tab2(self.organizer)
        ...
        tab_widget.addTab(self.tab1_instance,"Main Display")
    ...
    def refresh_tabs(self):
        self.organizer.organizeData()
        self.tab1_instance.refresh_modules(self.organizer)
...
if __name__ == "__main__":
    ...
    #time between refreshes in miliseconds
    timer.start(60000)
