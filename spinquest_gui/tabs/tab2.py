...
from spinquest_gui.plots.OrganizerStripCharts import OrgStripCharts
...
class Tab2(QWidget):
    def __init__(self, organizer : DataOrganizer):
        ...
        #self.charts = OrgStripCharts(organizer)
    ...
    def refresh(self, organizer : DataOrganizer):
        #self.charts.DrawSpill(organizer)
