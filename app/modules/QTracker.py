...
# External Package | uproot
# > for reading ROOT files, a common data format in particle physics.
import uproot  

# External Package | numba
# > Just-In-Time (JIT) compiler for speeding up Python code.
# > njit for compiling functions, prange for parallel loops.
from numba import njit, prange

# External Package | TensorFlow
